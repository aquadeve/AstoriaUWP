...
{
    /// <summary>
    /// Abstract base class for ListView and GridView.
    /// </summary>
    public abstract class AbsListView : ViewGroup
    {
        private object adapter;

        public AbsListView(Context c, AttributeSet a) : base(c, a) { }
        ...
        public int getCheckedItemPosition() { return -1; }
